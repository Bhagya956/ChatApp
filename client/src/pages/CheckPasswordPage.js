...
const CheckPasswordPage = () => {
  ...
  const handleSubmit = async(e)=>{
    ...
    // const URL = "https://chatapp-2-035r.onrender.com/api/password"
    ...
    try {
        ...
        // console.log("bda",response?.data?.token)
...
//           // Navigate to the messages page or the desired page
//           navigate(`/messages/${location?.state?._id}`);
//         } else {
//           console.error("Token is undefined or null.");
//         }
//       } else {
//         console.error("Login was not successful:", response.data);
//       }
//     } catch (error) {
//       toast.error(error?.response?.data?.message);
